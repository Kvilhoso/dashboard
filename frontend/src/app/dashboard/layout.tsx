...
export default function DashboardLayout({
  ...
  return (
    <div className='min-h-screen bg-black flex'>
      <aside
        className='w-64 border-r border-white/10 flex flex-col py-8 px-4 shrink-0'
      ...
      >
        ...
        <div className='px-3 mb-6'>
          ...
          >
            <span
              className={`w-1.5 h-1.5 rounded-full ${active ? 'bg-white/60' : 'bg-gray-700'}`}
            />
          ...
          {NAV.map(item => {
            ...
            if (locked) {
              return (
                <div
                  key={item.href}
                  className='flex items-center gap-3 px-3 py-2.5 rounded-xl text-gray-700 cursor-not-allowed select-none'
                >
        ...
        <div className='border-t border-white/10 pt-4 mt-4'>
          ...
          <button
            ...
            className='flex items-center gap-3 px-3 py-2.5 rounded-xl text-gray-600 hover:text-white hover:bg-white/5 transition w-full'
          >
