...
const MONTHLY_DATA = [
  ...
  { month: 'Ago/25', pnl: 1558.2, balance: 23509.18 },
  { month: 'Set/25', pnl: 2385.26, balance: 25735.28 },
  { month: 'Out/25', pnl: 1910.79, balance: 27516.4 },
  { month: 'Nov/25', pnl: 2322.62, balance: 29674.71 },
  { month: 'Dez/25', pnl: 3564.3, balance: 33009.79 },
...
export default function OverviewPage() {
  ...
  return (
    <div className='p-8 max-w-6xl mx-auto'>
      ...
      >
        ...
        <div className='flex items-end justify-between'>
          ...
          <div className='text-right'>
            ...
            <p className='num text-3xl font-light text-white'>
              +{STATS.returnPct}%
            </p>
          </div>
        </div>
      ...
      <div className='grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6'>
        {[
          ...
          },
          {
            label: 'Win Rate',
            value: `${STATS.winRate}%`,
            sub: `${STATS.wins}W · ${STATS.losses}L · ${STATS.trades} trades`,
            positive: true,
            delay: 0.12,
          },
          {
            label: 'P&L Fev/26',
            value: fmt(STATS.pnlMonth),
            sub: `Jan/26: ${fmt(STATS.pnlPrev)}`,
            positive: STATS.pnlMonth >= 0,
            delay: 0.18,
          },
      ...
      >
        ↳ backtest · Rage_Dev_Alvo_v5 · XAUUSD H1 · Exness-MT5Real12 · capital
        inicial $8.000 · Jan/2025–Fev/2026
      </motion.p>
    </div>
  );
}
