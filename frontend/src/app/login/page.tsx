  ...
  return (
    <div className='min-h-screen bg-black flex flex-col items-center justify-center px-6 relative overflow-hidden'>
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 55% 65% at 50% 50%, transparent 20%, rgba(0,0,0,0.7) 100%)',
        }}
      />
        ...
        <div className='px-8 py-8'>
          ...
          <form onSubmit={handleSubmit} className='space-y-4'>
            ...
            <button
              ...
              className='w-full bg-white text-black py-3.5 rounded-full text-xl hover:bg-gray-100 disabled:bg-gray-800 disabled:text-gray-600 disabled:cursor-not-allowed transition-all duration-200 mt-2 relative flex items-center justify-center'
            >
              {loading ? (
                ...
                <>
                  <img
                    src='/logo-circle.png'
                    alt=''
                    className='w-12 h-12 rounded-full absolute left-2'
                  />
                  Entrar
                </>
              )}
